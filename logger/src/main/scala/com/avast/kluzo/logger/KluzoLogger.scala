...
final class KluzoLogger private[logger](val underlying: Slf4jLogger) {
  ...
  def trace(message: String, args: Any*)(implicit traceId: TraceId): Unit = macro KluzoLoggerMacros.traceMessageArgs
  ...
  def trace(marker: Marker, message: String, args: Any*)(implicit traceId: TraceId): Unit = macro KluzoLoggerMacros.traceMessageArgsMarker
  ...
  def debug(message: String, args: Any*)(implicit traceId: TraceId): Unit = macro KluzoLoggerMacros.debugMessageArgs
  ...
  def debug(marker: Marker, message: String, args: Any*)(implicit traceId: TraceId): Unit = macro KluzoLoggerMacros.debugMessageArgsMarker
  ...
  def info(message: String, args: Any*)(implicit traceId: TraceId): Unit = macro KluzoLoggerMacros.infoMessageArgs
  ...
  def info(marker: Marker, message: String, args: Any*)(implicit traceId: TraceId): Unit = macro KluzoLoggerMacros.infoMessageArgsMarker
  ...
  def warn(message: String, args: Any*)(implicit traceId: TraceId): Unit = macro KluzoLoggerMacros.warnMessageArgs
  ...
  def warn(marker: Marker, message: String, args: Any*)(implicit traceId: TraceId): Unit = macro KluzoLoggerMacros.warnMessageArgsMarker
  ...
  def error(message: String, args: Any*)(implicit traceId: TraceId): Unit = macro KluzoLoggerMacros.errorMessageArgs
  ...
  def error(marker: Marker, message: String, args: Any*)(implicit traceId: TraceId): Unit = macro KluzoLoggerMacros.errorMessageArgsMarker
