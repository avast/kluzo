...
private[logger] object KluzoLoggerMacros {
  ...
  def traceMessageArgs(c: LoggerContext)(message: c.Expr[String], args: c.Expr[AnyRef]*)(traceId: c.Expr[TraceId]) = {
    import c.universe._
    val underlying = q"${c.prefix}.underlying"
    val mod = c.Expr( q""" "["+$traceId.value + "] " + $message""")
    if (args.length == 2)
  ...
  def traceMessageArgsMarker(c: LoggerContext)(marker: c.Expr[Marker], message: c.Expr[String], args: c.Expr[AnyRef]*)(traceId: c.Expr[TraceId]) = {
    import c.universe._
    val underlying = q"${c.prefix}.underlying"
    val mod = c.Expr( q""" "["+$traceId.value + "] " + $message""")
    if (args.length == 2)
  ...
  def debugMessageArgs(c: LoggerContext)(message: c.Expr[String], args: c.Expr[AnyRef]*)(traceId: c.Expr[TraceId]) = {
    import c.universe._
    val underlying = q"${c.prefix}.underlying"
    val mod = c.Expr( q""" "["+$traceId.value + "] " + $message""")
    if (args.length == 2)
  ...
  def debugMessageArgsMarker(c: LoggerContext)(marker: c.Expr[Marker], message: c.Expr[String], args: c.Expr[AnyRef]*)(traceId: c.Expr[TraceId]) = {
    import c.universe._
    val underlying = q"${c.prefix}.underlying"
    val mod = c.Expr( q""" "["+$traceId.value + "] " + $message""")
    if (args.length == 2)
  ...
  def infoMessageArgs(c: LoggerContext)(message: c.Expr[String], args: c.Expr[AnyRef]*)(traceId: c.Expr[TraceId]) = {
    import c.universe._
    val underlying = q"${c.prefix}.underlying"
    val mod = c.Expr( q""" "["+$traceId.value + "] " + $message""")
    if (args.length == 2)
  ...
  def infoMessageArgsMarker(c: LoggerContext)(marker: c.Expr[Marker], message: c.Expr[String], args: c.Expr[AnyRef]*)(traceId: c.Expr[TraceId]) = {
    import c.universe._
    val underlying = q"${c.prefix}.underlying"
    val mod = c.Expr( q""" "["+$traceId.value + "] " + $message""")
    if (args.length == 2)
  ...
  def warnMessageArgs(c: LoggerContext)(message: c.Expr[String], args: c.Expr[AnyRef]*)(traceId: c.Expr[TraceId]) = {
    import c.universe._
    val underlying = q"${c.prefix}.underlying"
    val mod = c.Expr( q""" "["+$traceId.value + "] " + $message""")
    if (args.length == 2)
  ...
  def warnMessageArgsMarker(c: LoggerContext)(marker: c.Expr[Marker], message: c.Expr[String], args: c.Expr[AnyRef]*)(traceId: c.Expr[TraceId]) = {
    import c.universe._
    val underlying = q"${c.prefix}.underlying"
    val mod = c.Expr( q""" "["+$traceId.value + "] " + $message""")
    if (args.length == 2)
  ...
  def errorMessageArgs(c: LoggerContext)(message: c.Expr[String], args: c.Expr[AnyRef]*)(traceId: c.Expr[TraceId]) = {
    import c.universe._
    val underlying = q"${c.prefix}.underlying"
    val mod = c.Expr( q""" "["+$traceId.value + "] " + $message""")
    if (args.length == 2)
  ...
  def errorMessageArgsMarker(c: LoggerContext)(marker: c.Expr[Marker], message: c.Expr[String], args: c.Expr[AnyRef]*)(traceId: c.Expr[TraceId]) = {
    import c.universe._
    val underlying = q"${c.prefix}.underlying"
    val mod = c.Expr( q""" "["+$traceId.value + "] " + $message""")
    if (args.length == 2)
